...
def table_head_extract(text):
    ...
    while tag:
        ...
        if "表头" in result and json_left_index != -1 and json_right_index != -1:
            try:
                table_head = ast.literal_eval(result[json_left_index:json_right_index + 1])
