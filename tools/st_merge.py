...
def is_merge(first_sub_table:Set[Node], second_sub_table:Set[Node])->bool:
    ...
    for cell in first_sub_table:
        first_sub_table_left_index = cell.colspan[0] if first_sub_table_left_index>cell.colspan[0] else first_sub_table_left_index
        first_sub_table_right_index = cell.colspan[1] if first_sub_table_right_index < cell.colspan[1] else first_sub_table_right_index
        first_sub_table_up_index = cell.rowspan[0] if first_sub_table_up_index > cell.rowspan[0] else first_sub_table_up_index
        first_sub_table_down_index = cell.rowspan[1] if first_sub_table_down_index< cell.rowspan[1] else first_sub_table_down_index
    ...
    for cell in second_sub_table:
        second_sub_table_left_index = cell.colspan[0] if second_sub_table_left_index > cell.colspan[0] else second_sub_table_left_index
        second_sub_table_right_index = cell.colspan[1] if second_sub_table_right_index < cell.colspan[1] else second_sub_table_right_index
        second_sub_table_up_index = cell.rowspan[0] if second_sub_table_up_index > cell.rowspan[0] else second_sub_table_up_index
        second_sub_table_down_index = cell.rowspan[1] if second_sub_table_down_index < cell.rowspan[1] else second_sub_table_down_index
    ...
    if first_sub_table_up_index==second_sub_table_up_index and first_sub_table_down_index==second_sub_table_down_index:
        ...
        for i_first_sub_table_value_range in first_sub_table_value_range:
            for i_second_sub_table_value_range in second_sub_table_value_range:
                if i_first_sub_table_value_range[0] < i_second_sub_table_value_range[0] < i_first_sub_table_value_range[1] < \
                        i_second_sub_table_value_range[1]:
                    print(9)
                    return False
                if i_second_sub_table_value_range[0] < i_first_sub_table_value_range[0] < i_second_sub_table_value_range[1] < \
            ...
            for j in range(len(segmented_table)):
                ...
                if is_merge(segmented_table[i],segmented_table[j]):
                    ...
                    for cell in list(segmented_table[i]):
                        print("context:", cell.context, end="#")
